const menuItems = [
    ...
    { name: "Masala Soda", price: 5.99, category: "drinks", img: "assets/soda.jpeg" },
...
const comboOffers = {
    dailySpecial: [
        ...
        },
        {
            name: "Rice & Dal Bowl",
            price: 11.99,
            availability: "All Days — Dine-In & To-Go",
            includes: "Steamed Rice · Dal Tadka · Pickle",
            img: "assets/rice_dal_bowl.jpg"
        },
        {
            name: "Rice & Paneer Bowl",
            price: 13.99,
            availability: "All Days — Dine-In & To-Go",
            includes: "Steamed Rice · Paneer Curry · Raita · Pickle",
            img: "assets/rice_paneer_bowl.jpg"
        },
    ],
    weekendUnlimited: [
        {
